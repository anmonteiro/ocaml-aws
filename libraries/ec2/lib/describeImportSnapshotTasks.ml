...
module DescribeImportSnapshotTasksRequest =
  struct
    type t =
      ...
      filters: FilterList.t [@ocaml.doc "<p>The filters.</p>"];
      import_task_ids: ImportTaskIdList.t
        [@ocaml.doc "<p>A list of import snapshot task IDs.</p>"];
...
let to_http service region req =
  ...
  (`POST, uri,
    (Headers.render (DescribeImportSnapshotTasksRequest.to_headers req)), "")
let of_http headers
