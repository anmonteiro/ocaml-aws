...
module ReplaceNetworkAclEntryRequest =
  struct
    type t =
      ...
      network_acl_id: String.t [@ocaml.doc "<p>The ID of the ACL.</p>"];
      ...
      rule_number: Integer.t
        [@ocaml.doc "<p>The rule number of the entry to replace.</p>"]}
...
let to_http service region req =
  ...
  (`POST, uri,
    (Headers.render (ReplaceNetworkAclEntryRequest.to_headers req)), "")
let of_http headers
